    ...
    internal class PowderGangScene : BaseScene
    {
        ...
        public override void Render()
        {
            ...
            if (Game.progess[5])
            {
                ...
                Util.Print("1. 파우더 갱단들에게 링고의 위치를 발설한다");
                Util.Print("2. 파우더 갱단들이 누구냐?");
                Util.Print("3. NCR에 대해 물어본다");
                Util.Print("[CHR 7] [LUK 7] 4. 파우더 갱어들에게 링고가 NCR 마을 근처에서 보였다는 거짓말을 한다.");
                Util.Print("[STR 8] 5. 파우더 갱어들에게 \"정중히\" 이 마을에서 꺼지라고 말한다.");
                Util.Print("S. 마을 남쪽으로 돌아간다");
            }
            else
            {
